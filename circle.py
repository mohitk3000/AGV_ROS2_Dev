...
# importing the required module for plot
...
class movecircleNode(Node):
    ...
    def odom_callback(self, msg: Odometry):
        ...
        if self._mved_distance.data< float(radius_in_meter)-0.02:
            # print(dist)
            # print("to radius")
            twist=Twist()
            pose=Pose()
            ...
            twist.angular.z = 0.0  # angular velocity in rad/s
...
# Add labels and legend
    ...
    def calculate_distance(self, new_position, old_position):
        ...
        y2 = new_position.y
        y1 = old_position.y
        dist = float(abs(x2 - x1)) #calculate distance using formulae
        return dist
